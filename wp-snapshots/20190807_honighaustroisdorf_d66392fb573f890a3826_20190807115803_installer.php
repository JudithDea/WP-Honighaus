...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20190807_honighaustroisdorf_d66392fb573f890a3826_20190807115803_archive.zip';
	const ARCHIVE_SIZE		 = '32443177';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'd66392f-07115803';
	...
	public function run()
	{
		...
		self::log('==DUPLICATOR INSTALLER BOOTSTRAP v1.3.18==');
		self::log('----------------------------------------------------');
