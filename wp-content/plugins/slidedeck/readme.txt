...
Create Amazing Responsive WordPress Slider In Minutes, With No Code.

SlidDeck is a popular slider plugin for all your image and video slides.

Since it’s inception, SlideDeck has evolved from a mere Image Slider to a feature-rich content slider.

SlideDeck makes it extremely easy to create a WordPress slideshow with features like responsive slider, touch swipe, smooth transitions, SEO friendly and many more!

With SlideDeck's latest version - 5, we are further simplifying it for everyone to try and use.

SlideDeck v5 includes a set of a core free image sliders with addons available for additional and enhanced features.
...
* Choose from 50+ smooth transition effects, whichever best suites your WordPress slideshow.
...
* Create a mixed content slider that has image, video and text in it.
...
* Quick support from our developers for any issues with SlideDeck plugin.
...
= 5.3.3 =
Made compatible to new lens Infinity.
...
= 5.1.2 =
  Feature Enhancement : Released new template - Corporate.
